...
from waveguide_opt.full_optimization_loop import run_minimal_loop


def main() -> int:
    parser = argparse.ArgumentParser(description="Run minimal GA optimization loop.")
    ...
    try:
        ...
        print("Minimal optimization: FAIL")
        print(f"Reason: {exc}")
        return 1

    print("Minimal optimization: PASS")
